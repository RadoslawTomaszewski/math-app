    ...
    <>
      <div className="p-3 justify-center flex flex-col items-center">
        <ArticleWrapper>
          ...
          <span>Jeżeli sprawiłem, że zaoszczędziłeś swój czas lub dowiedziałeś się czegoś ciekawego rozważ wsparcie tego projektu naciskając poniższy przycisk </span><br />
