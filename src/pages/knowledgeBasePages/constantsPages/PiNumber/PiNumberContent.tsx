...
const PiNumberContent: FC = () => {
  ...
  return (
    <>
      ...
      <Formula formula="\frac{103993}{33102}" />
      <Formula formula="\frac{104348}{33215}" />
      <p>Zapisy w postaci ułamka łańcuchowego:</p>
      <Formula formula="\pi = 3 + \cfrac{1}{6 + \cfrac{3}{6 + \cfrac{5}{6 + \cfrac{7}{\cdots}}}}" />
      <Formula formula="\frac{104348}{33215}" />
    </>
  );
};
