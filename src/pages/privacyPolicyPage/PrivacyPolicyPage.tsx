        ...
        <div className="p-3 justify-center flex flex-col items-center">
            <ArticleWrapper>
                <div className="flex flex-col bg-articleColor p-4">
                    ...
                    <p>Oto polityka prywatności, która opisuje, w jaki sposób są gromadzone, używane i chronione Twoje dane osobowe.</p>
                    <br />
                    ...
                    <p className="ml-5"><b>a. Dane wprowadzane przeż użytkownika podczas rejestracji konta:</b></p>
                    <div className="ml-8">
                    ...
                    <p className="ml-5">Nigdy nie udostępniam Twoich danych stronom trzecim, zastrzegam jednak taką możliwość jeżeli jest to wymagane przez prawo (organom publicznym przeciwdziałającym nadużyciom)</p>
                    <br />
                    ...
                    <ul className="list-disc ml-5">
                        <li>Masz prawo do nie wyrażenia zgody na przetwarzanie Twoich danych osobowych</li>
                    ...
                    <p><b>(7) Opłaty</b></p>
                    <ul className="list-disc ml-5">
                        <li><b>majza.eu</b> jest w pełni darmową platformą. Rejestracja konta i dostęp do zasobów strony jest w pełni darmowy. Zastrzegam sobie jednak prawo do wprowadzenia opłat w przyszłości.</li>
